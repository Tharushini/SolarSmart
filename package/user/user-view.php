...
$dbQuery = "SELECT * FROM `users` where `userId`='".$userId."';";
...
if ($type === "edit" && isset($_POST['update'])) {
...
//            header('Location: user-view.php?uid='.$userId.'&type=view');
//            exit();
        }
    }
}
...
?>
    <div class="container mt-5">
        <div class="row">
            <?php if ($type === "view"): ?>
                <h3 class="display-4 h6">User profile</h3>
        ...
        <form method="post" class="mt-4" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <div class="profile-img">
                        <img src="../../res/img/<?php echo $_SESSION['proImg']; ?>"
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="fname" class="form-control <?php if (isset($error['fname'])) : echo "is-invalid"; endif; ?>"
                        <?php if (isset($_POST['fname'])): echo 'value="'.$_POST['fname'].'"'; endif; ?> placeholder="Dulip"
                           value="<?php echo $userInfo['fName']; ?>" <?php if ($type === "view") { echo "disabled"; } ?> />
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="lname" class="form-control <?php if (isset($error['lname'])) : echo "is-invalid"; endif; ?>"
                        <?php if (isset($_POST['lname'])): echo 'value="'.$_POST['lname'].'"'; endif;?> placeholder="Max"
                           value="<?php echo $userInfo['lName']; ?>" <?php if ($type === "view") { echo "disabled"; } ?> />
            ...
            <div class="form-group">
                ...
                <input type="text" name="dispName" class="form-control <?php if (isset($error['dispName'])) : echo "is-invalid"; endif; ?>"
                    <?php if (isset($_POST['dispName'])): echo 'value="'.$_POST['dispName'].'"'; endif; ?> placeholder="Dulip"
                       value="<?php echo $userInfo['dispName']; ?>" <?php if ($type === "view") { echo "disabled"; } ?> />
            ...
            <div class="form-group">
                ...
                <input type="text" name="address" class="form-control <?php if (isset($error['address'])) : echo "is-invalid"; endif; ?>"
                    <?php if (isset($_POST['address'])): echo 'value="'.$_POST['address'].'"'; endif; ?> placeholder="1817 Main Street"
                       value="<?php echo $userInfo['addr']; ?>" <?php if ($type === "view") { echo "disabled"; } ?> />
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="nic" class="form-control <?php if (isset($error['nic'])) : echo "is-invalid"; endif; ?>"
                        <?php if (isset($_POST['nic'])): echo 'value="'.$_POST['nic'].'"'; endif; ?> placeholder="123456789V"
                           value="<?php echo $userInfo['nic']; ?>" <?php if ($type === "view") { echo "disabled"; } ?> />
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" name="mNumber" class="form-control <?php if (isset($error['mNumber'])) : echo "is-invalid"; endif; ?>"
                        <?php if (isset($_POST['mNumber'])): echo 'value="'.$_POST['mNumber'].'"'; endif; ?> placeholder="0112548798"
                           value="<?php echo $userInfo['telNum']; ?>" <?php if ($type === "view") { echo "disabled"; } ?> />
            ...
            <?php if ($type === "view" && $_SESSION['userId'] == $userId): ?>
                <a href="user-view.php?uid=<?php echo $userId; ?>&type=edit" class="btn btn-primary">Edit</a>
            <?php elseif ($type === "edit"): ?>
